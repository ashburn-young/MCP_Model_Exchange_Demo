// test-model-switching.js - Direct API test for model switching functionality
import axios from 'axios';

// Configuration
const API_URL = 'https://ca-retail-3f5b3811.orangemushroom-044f259b.swedencentral.azurecontainerapps.io/api';
...
async function runAllTests() {
  console.log('=========================================');
  console.log('SMART RETAIL ASSISTANT - MODEL SWITCHING TEST');
  console.log('=========================================');
