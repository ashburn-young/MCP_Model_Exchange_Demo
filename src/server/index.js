...
app.use(cors({
  origin: function(origin, callback) {
    // Allow any origin in development/when not specified
    if (!origin) return callback(null, true);
    
    // Allow our own domain and localhost variants
    const allowedOrigins = [
      'http://localhost:3000', 
      'http://localhost:3002',
      'http://localhost:3005',
      'https://ca-retail-4ea43e52.redocean-8ebb178a.swedencentral.azurecontainerapps.io'
    ];
