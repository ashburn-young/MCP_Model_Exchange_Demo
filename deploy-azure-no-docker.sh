...
# Configuration
RESOURCE_GROUP_NAME="rg-smart-retail-app4"  # Updated to prevent conflicts with previous deployments
LOCATION="swedencentral"
ENVIRONMENT_NAME="retailassistant7"  # Updated to prevent conflicts with previous deployments
